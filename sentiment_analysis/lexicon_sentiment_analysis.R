...
# Load the same csv
trip <- read.csv("C:/Users/DELL LAPTOP/Sentiment-Analysis-TripAdvisor/data/restaurant5.csv")
hotel_reviews <- as.character(trip$review)

# Load the positive and negative lexicon data and explore
positive_lexicon <- read.csv("C:/Users/DELL LAPTOP/Sentiment-Analysis-TripAdvisor/data/positive-lexicon.txt")
negative_lexicon <- read.csv("C:/Users/DELL LAPTOP/Sentiment-Analysis-TripAdvisor/data/negative-lexicon.txt")
