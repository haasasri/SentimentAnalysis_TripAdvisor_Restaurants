library(rvest)
url <- paste0("https://www.tripadvisor.in/Restaurant_Review-g60763-d2009679-Reviews-Rubirosa-New_York_City_New_York.html")
...
write.table(df1,file="C:/Users/DELL LAPTOP/Sentiment-Analysis-TripAdvisor/data/restaurant4.csv",sep=",",row.names = F)